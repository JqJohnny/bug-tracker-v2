1. Bug Hunt .V2 is a planned update to include a CRUD database with API endpoints and is currently in progress 04/29/2026.

3. Users are able to create project-specific tickets that allows them to keep track of bugs, issues, and feature requests.
...
4. Project's Future - This project is far from done and has a ton of room to grow. It has taught me how to write
...
5. Website's URL (Still in Development): https://bug-hunt-b860b.web.app
